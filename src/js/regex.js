...
UNICODE.cjk = UNICODE.hanzi
UNICODE.greek = UNICODE.ellinika
UNICODE.cyrillic = UNICODE.kirillica
UNICODE.hangul = UNICODE.eonmun
...
export const TYPESET = {
  ...
  group: {
    ...
    kana: new RegExp('(' + rKana + '|' + rKanaS + '|' + rKanaH + ')+', 'g'),
    hangul: new RegExp('(' + rEon + '|' + rEonH + '|' + rPt + ')+', 'g'),
